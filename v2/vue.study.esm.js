    ...
    generateComponentTrace = function (vm) {
        if (vm._isVue && vm.$parent) {
            ...
            return ('\n\nfound in\n\n' +
                tree
                    .map(function (vm, i) {
                    return "".concat(i === 0 ? '---> ' : repeat_1(' ', 5 + i * 2)).concat(Array.isArray(vm)
...
export { Observer, Vue, Watcher, toggleDebugger };
//# sourceMappingURL=vue.study.esm.js.map
